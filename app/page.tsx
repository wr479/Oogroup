    ...
    <div className="min-h-dvh flex flex-col bg-background">
      <main className="flex-1">
        ...
        <section className="py-6">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <Reveal>
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-slate-900 dark:text-white">Преимущества работы с нами</h2>
              </Reveal>
            </div>
          </div>
        </section>
        ...
        <section className="relative py-12 md:py-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-10 items-center">
            <Reveal className="space-y-4 md:space-y-6">
              <div className="text-xs font-semibold tracking-wider uppercase text-slate-500">НАДЕЖНОСТЬ</div>
              <h3 className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-white">Финансы и стабильность</h3>
            ...
            <Reveal delay={0.1} className="relative">
              ...
              <div className="relative ml-8 md:ml-12 bg-white dark:bg-slate-900 rounded-xl shadow-xl overflow-hidden border border-black/5">
                <Image src="/hero-main.png" alt="Иллюстрация" width={720} height={480} className="w-full h-auto" />
              </div>
            </Reveal>
          </div>
        </section>
        ...
        <section className="relative py-12 md:py-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-10 items-center">
            <Reveal className="space-y-4 md:space-y-6">
              <div className="text-xs font-semibold tracking-wider uppercase text-slate-500">ФОРМАТ И СВОБОДА</div>
              <h3 className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-white">Свобода выбора и комфорт</h3>
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
              ...
              <div className="flex items-baseline gap-3">
                ...
                <span className="text-slate-500">Удобный формат</span>
              </div>
            </Reveal>
            <Reveal delay={0.1} className="relative">
              <div className="absolute right-0 top-1/2 -translate-y-1/2 w-56 sm:w-72 md:w-80 h-56 sm:h-72 md:h-80 bg-red-600 rounded-l-full" aria-hidden="true"></div>
        ...
        <section className="relative py-12 md:py-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-10 items-center">
            <Reveal className="space-y-4 md:space-y-6">
              <div className="text-xs font-semibold tracking-wider uppercase text-slate-500">РАЗВИТИЕ И ПОДДЕРЖКА</div>
              <h3 className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-white">Растите вместе с нами</h3>
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
              ...
              <div className="flex items-baseline gap-3">
                ...
                <span className="text-slate-500">Средняя зарплата по компаниям</span>
              </div>
            </Reveal>
            <Reveal delay={0.1} className="relative">
              <div className="absolute right-0 top-1/2 -translate-y-1/2 w-56 sm:w-72 md:w-80 h-56 sm:h-72 md:h-80 bg-red-600 rounded-l-full" aria-hidden="true"></div>
        ...
        <section className="relative py-12 md:py-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-10 items-center">
            <Reveal className="space-y-4 md:space-y-6">
              <div className="text-xs font-semibold tracking-wider uppercase text-slate-500">ТЕХНОЛОГИИ И ПРОСТОТА</div>
              <h3 className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-white">Всё понятно и удобно</h3>
              <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
              ...
              <div className="flex items-baseline gap-3">
                ...
                <span className="text-slate-500">Ответ поддержки</span>
              </div>
            </Reveal>
            <Reveal delay={0.1} className="relative">
